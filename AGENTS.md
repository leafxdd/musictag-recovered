...
This project is indexed by GitNexus as **musictag-recovered** (4035 symbols, 12459 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
