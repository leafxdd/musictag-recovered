...
internal class EditableListView : HeaderAwareListView
{
	...
	private void DrawCustomColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
	{
		...
		CheckBoxRenderer.DrawCheckBox(e.Graphics, new Point(e.Bounds.Left + 4, e.Bounds.Top + ImageUtilities.ScaleByDpi(4f, this)), isChecked ? CheckBoxState.CheckedNormal : CheckBoxState.UncheckedNormal);
	}
